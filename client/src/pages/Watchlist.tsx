    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex justify-between items-end mb-8">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400 mt-2">Auctions you're keeping an eye on.</p>
        </div>
      </div>
      ...
      {watchlist.length === 0 ? (
        <div className="bg-white dark:bg-white/5 p-10 rounded-2xl text-center border border-slate-200 dark:border-white/10 backdrop-blur-xl shadow-xl">
          <p className="text-slate-600 dark:text-slate-400 mb-6 text-lg">Your watchlist is empty.</p>
